    ...
    itinerary: [
      {
        title: 'Day 1: Tampa',
        description:
          'Set sail from Florida’s Gulf Coast and you’ll discover just how convenient — and action-packed — cruises out of Tampa can be. Welcome to one of Florida’s busiest ports — where the historically Cuban district',
      },
      {
      ...
      },
      {
        ...
        description:
          'Cruises to Key West are packed with coastal-town energy and layers of American history just waiting to be discovered. Enjoy a laidback Caribbean vibe with a dash of the high life on Carnival cruises',
      },
      {
